...
function prime_num() {
                ...
                limit = parseInt(document.getElementById('prime_limit').value);
                ...
                for (i = 1; i <= limit; i++) {
                    ...
                    if (c == 2) {
                    	document.getElementById("prime_answer").innerHTML = document.getElementById("prime_answer").innerHTML + " " + i;
                        /*document.getElementById("prime_answer").insertAdjacentHTML('beforeend', i);
*/                    }
                }
            }